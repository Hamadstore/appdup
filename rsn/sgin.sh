...
# اسم شهادة المطورين
Certificate_Name="iPhone Distribution: mohammed alfadhel (6JTQ6VL8UA)"

# مسار بروفايل
Profile_Path="/Applications/MAMP/htdocs/app4bd/app4bd/rsn/embedded.mobileprovision"
...
OUTPUT_DIR="/Applications/MAMP/htdocs/app4bd/app4bd/sginDN"
